...
public class EcomNewPaymentMain {
    private static final Logger LOG = LoggerFactory.getLogger(EcomNewPaymentMain2.class);
    ...
    private static Properties loadProperties() {
        ...
        try (var inputStream = EcomNewPaymentMain2.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (inputStream == null) {
